...
-- ----------------------------
-- Table structure for bili_user_follower
-- ----------------------------
DROP TABLE IF EXISTS `bili_user_follower`;
CREATE TABLE `bili_user_follower`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `mid` bigint(20) NULL DEFAULT NULL COMMENT '用户ID',
  `following` bigint(20) NULL DEFAULT NULL COMMENT '关注别人数',
  `whisper` bigint(20) NULL DEFAULT NULL COMMENT 'whisper',
  `black` bigint(20) NULL DEFAULT NULL COMMENT '黑名单数',
  `follower` bigint(20) NULL DEFAULT NULL COMMENT '关注数',
  `gmt_create` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_modified` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY USING BTREE (`id`),
  INDEX `idx_create_time_mid` USING BTREE(`gmt_create`, `mid`)
...
CREATE TABLE `wechat_app_config`  (
  ...
  `access_token` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '调用接口凭证',
